...
.control
	...
	op
	write initial.raw
	print 1/(@m.xm6.msky130_fd_pr__nfet_01v8[gds])
.endc"}
C {vsource.sym} -340 130 0 0 {name=Vin1 value=0.5995 savecurrent=false}
...
C {vsource.sym} -10 130 0 0 {name=Vin2 value=0.6005 savecurrent=false}
C {gnd.sym} -10 160 0 0 {name=l5 lab=0}
